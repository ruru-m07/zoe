...
import { CopyButton, CopyNpmCommandButton } from "./mdx/copy-button";
import Link from "next/link";
import { CodeBlockWrapper } from "./mdx/code-block-wrapper";
...
import { NpmCommands } from "@/interface/unist";
...
const MarkdownReader = ({ markdown }: { markdown: any }) => {
  ...
  const Mdgenerating = async () => {
    const file = await remark().use(remarkGfm).use(remarkGemoji).process(text);
